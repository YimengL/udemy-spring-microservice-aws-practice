...
```
docker run --publish 8100:8100 --network currency-network --env CURRENCY_EXCHANGE_URI=http://currency-exchange-service:8000 rocklee1108/aws-currency-conversion-service:0.0.1-SNAPSHOT
```
